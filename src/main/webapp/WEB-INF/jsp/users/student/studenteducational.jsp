	...
	<br/>
	    ...
	    <c:forEach  items="${listEducationalinfo}" var="educationalinfo">
	    	<tr>
					...
					<td align="center"><a href="/gapp/users/student/educationalinfo/remove/${user.userid}/${application.applicationid}/${student.studentid}/${educationalinfo.educationalid}.html"/>Remove</a></td>
				</tr>
	   		</c:forEach>
