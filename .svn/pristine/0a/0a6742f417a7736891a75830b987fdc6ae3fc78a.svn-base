...
<body>
	...
	<div class="container">
		...
		<form:form modelAttribute="customfield" class="text-center">
		...
		<table border = 1>
			...
			<tr>
				...
				<td><form:select path="department.departmentid">
							...
							<c:forEach items="${depta}" var="department">">
				...
				<input type="submit" name="save" value="Save Additional Requirements" />	
